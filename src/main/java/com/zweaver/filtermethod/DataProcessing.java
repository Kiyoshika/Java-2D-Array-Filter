...
public class DataProcessing {
    ...
    // leeched this method from stack overflow: https://stackoverflow.com/questions/3422673/how-to-evaluate-a-math-expression-given-in-string-form
    ...
    The above expression will return results where column 0 > 5 OR (column 2 <= 4 AND column 2 > 1)
    */  
                ...
                if (!longCondition) {
                    switch(conditionText.substring(0, 1)) {
                        ...
                        case "=":
                            ...
                            logicalExpressions[currentRow] += (data[currentRow][currentColumn].equals(conditionText.substring(1))) ? "1" : "0";
                            // if logical is AND then multiply, else (OR) add
                            // Don't add any symbols at the end of an expression (or just ignore last expression)
                            if (currentExpression != conditions.length - 1 && currentRow != data.length - 1) {
